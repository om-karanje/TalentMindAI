...
MAX_PROFILE_VIEWS = 374
MAX_RECRUITER_SAVES = 80
MAX_SEARCH_APPEARANCE = 1490
...
def calculate_market_interest_score(signals):
    ...
    profile_views_norm = min(profile_views /MAX_PROFILE_VIEWS,1.0)

    recruiter_saves_norm = min(recruiter_saves /MAX_RECRUITER_SAVES,1.0)

    search_appearance_norm = min(search_appearance /MAX_SEARCH_APPEARANCE,1.0)
